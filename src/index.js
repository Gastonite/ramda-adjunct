...
export { default as isObject } from './isObj.js'; // alias of isObject
...
export { default as isNotPlainObject } from './isNotPlainObj.js'; // alias of isNotPlainObject
...
export { default as thenP } from './thenP.js';
export { default as then } from './thenP.js';
...
export { default as contained } from './contained.js';
export { default as included } from './contained.js';
...
export { default as mergeLeft } from './mergeRight.js';
export { default as resetToDefault } from './mergeRight.js';
